...
| test-prompts.json | Agent-level scenarios, Groups A-E (14 from V2.0.x + 7 V2.1 procedure-selection cases, PRC-01..07). The id set is frozen in run.sh's scenario guard. |
